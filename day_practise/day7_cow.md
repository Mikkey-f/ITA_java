...
所有 *N*(1≤*N*≤20,000) 头奶牛都有一个确定的身高 *H**i*(1≤*H**i*≤10,000)。设所有奶牛身高的和为 *S*。书架的高度为 *B*，并且保证 1≤*B*≤*S*<2,000,000,007。
...
[P2676 [USACO07DEC\] Bookshelf B - 洛谷](https://www.luogu.com.cn/problem/P2676)



思路：还是采取一个快排思路，先对奶牛的身高排序，然后再用循环来判断奶牛身高和sum与书架之间的高度
